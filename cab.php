...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $date_of_booking = htmlspecialchars($_POST['date_of_booking']);
    $date_of_return = htmlspecialchars($_POST['date_of_return']);
   ...
   // $stmt = $conn->prepare("INSERT INTO company_details (Company_name,Contact_person,account_email,PhoneNum) VALUES (?,?,?,?)");
    ...
    $stmt = $conn->prepare("INSERT INTO bookings(name, car_number, date_of_booking, date_of_return, location) 
    VALUES (?,?,?,?,?)");
